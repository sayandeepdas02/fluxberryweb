    ...
    <div className="w-full bg-white relative opacity-0 animate-hero-wrapper">
      ...
      >
        ...
        <div className="relative z-20 px-4 md:px-12">
          <div className="h-8 md:h-12 w-full bg-diagonal-hatch border-y border-slate-200 bg-slate-50/50 opacity-60" />
        </div>

        <div className="mt-0 relative z-20 w-full">
          <div className="px-4 md:px-12 w-full mx-auto relative">
            <div className="absolute top-0 left-4 md:left-12 right-4 md:right-12 h-px bg-slate-200 z-30" />
            <div className="absolute bottom-0 left-4 md:left-12 right-4 md:right-12 h-px bg-slate-200 z-30" />
